...
object d3geo extends js.Object {
    ...
    def transform(methods: TransformMethods): TransformType = js.native
...
trait Path extends js.Function2[/*feature*/ js.Any, /*index*/ Double,String] {
    ...
    def centroid(feature: js.Any): js.Tuple2[Double, Double] = js.native
    def bounds(feature: js.Any): js.Tuple2[js.Tuple2[Double, Double], js.Tuple2[Double, Double]] = js.native
    def projection(): TransformType | js.Function1[js.Tuple2[Double, Double], js.Tuple2[Double, Double]] = js.native
    def projection(stream: TransformType): Path = js.native
...
@js.native
trait TransformType extends js.Object {
    def stream(stream: Listener): Listener = js.native
}

@js.native
trait ClipExtent extends TransformType {
    def extent(): js.Tuple2[js.Tuple2[Double, Double], js.Tuple2[Double, Double]] = js.native
